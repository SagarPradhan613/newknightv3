...
const RoiCalculatorModal: React.FC<React.PropsWithChildren<RoiCalculatorModalProps>> = ({
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    isFarm
      ...
      : t("“My Balance” here includes both KNIGHT in your wallet, and KNIGHT already staked in this pool.", {
  ...
  const editingUnit =
    editingCurrency === EditingCurrency.TOKEN ? (stakingTokenSymbol === "CAKE" ? "KNIGHT" : stakingTokenSymbol) : "USD";

  const editingValue = editingCurrency === EditingCurrency.TOKEN ? principalAsToken : principalAsUSD;
  // const conversionUnit = editingCurrency === EditingCurrency.TOKEN ? "USD" : stakingTokenSymbol;
  const conversionUnit =
    editingCurrency === EditingCurrency.TOKEN ? "USD" : stakingTokenSymbol === "CAKE" ? "KNIGHT" : stakingTokenSymbol;
      ...
      <ScrollableContainer>
        ...
        <Flex flexDirection="column" mb="8px">
          <Text color="secondary" bold fontSize="12px" textTransform="uppercase">
            ...
            {stakingTokenSymbol === "CAKE" ? t("KNIGHT staked") : t(`${stakingTokenSymbol} staked`)}
          </Text>
          <BalanceInput
            inputProps={{ scale: "sm" }}
