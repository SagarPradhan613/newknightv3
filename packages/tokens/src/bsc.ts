...
export const bscTokens = {
  ...
  guard: new ERC20Token(
    ChainId.BSC,
    '0xF606bd19b1E61574ED625d9ea96C841D4E247A32',
    18,
    'GUARD',
    'Guard Token',
    'https://www.wolfdencrypto.com/?r_done=1',
  ),
  wolfies: new ERC20Token(
    ChainId.BSC,
  ...
  fins: new ERC20Token(ChainId.BSC, '0x1b219Aca875f8C74c33CFF9fF98f3a9b62fCbff5', 18, 'FINS', 'Fins Token', ''),
  sing: new ERC20Token(
    ChainId.BSC,
  ...
  dsg: new ERC20Token(
    ...
    18,
    'DSG',
    'Dinosaur Eggs Token Token',
    'https://dsgmetaverse.com',
  ),
  pixelsquid: new ERC20Token(
    ChainId.BSC,
    '0x5A549cb605F1e651200c22d1A8482929b36330F7',
    18,
    'PixelSQUID',
    'PIXELSQUID',
    'https://pixelsquid.site/',
  ),
  metafish: new ERC20Token(
    ChainId.BSC,
  ...
  joke: new ERC20Token(
    ...
    'JOKE',
    'JOKE',
    'https://joke.community/',
  ),
  thunder: new ERC20Token(
    ChainId.BSC,
    '0xCf8F936D880a93E571cC2476C1B65508A918B5F9',
    9,
    'THUNDER',
    'THUNDER',
    'https://www.thethunderverse.com/',
  ),
  pdm: new ERC20Token(
    ChainId.BSC,
    '0x4F890381abE9917A1cFeD7951B7Eb79900f4830D',
    18,
    'PDM',
    'Padmon',
    'https://www.padmon.io/',
  ),
  dlaunch: new ERC20Token(
    ChainId.BSC,
    '0xD7D23d89c510f306e4037385EbbEFc6Dd6C41e61',
    18,
    'DLAUNCH',
    'DLAUNCH',
    'https://defilaunch.finance/',
  ),
  dust: new ERC20Token(
    ChainId.BSC,
    '0xE36E4CdF538ab62d283d1AE49007EEdFA9020497',
    18,
    'DUST',
    'DUST',
    ' https://spacedust.financial/',
  ),
  kronos: new ERC20Token(
    ChainId.BSC,
  ...
  marvin: new ERC20Token(
    ChainId.BSC,
    '0x71aB195498b6dC1656aBb4D9233f83Ae5F19495B',
    18,
    'MARVIN ',
    'MARVIN ',
    'http://marvininueth.com/',
  ),
  mbp: new ERC20Token(ChainId.BSC, '0xaF2F53cc6cc0384aba52275b0f715851Fb5AFf94', 18, 'MBP', 'MBP', ''),
  bhc: new ERC20Token(
    ChainId.BSC,
    ...
    'BHC',
    'Billion Happiness',
    'https://billionhappiness.finance/',
  ),
  frtna: new ERC20Token(
    ChainId.BSC,
    '0x3949D773d188Bb53E67CAE443Aa8e741878b5216',
    18,
    'Fortuna',
    'FRTNA',
  ...
  swc: new ERC20Token(
    ...
    'SWC',
    'Shiba World Cup',
    'https://shiba-worldcup.io/',
  ),
  alyx: new ERC20Token(ChainId.BSC, '0x2701C7cBf3220FFF6e6CEaabbCD9B932Eb11E3Ff', 18, 'ALYX', 'Alyx Token', '/#'),
  bkb: new ERC20Token(
    ChainId.BSC,
    '0xf9068051606E749208D9969D6A7C8167af5Ed9b4',
    18,
    'BKB',
    'BLOCKOMBAT BSC',
    'https://blockombat.com/',
  ),
  ada: new ERC20Token(
    ChainId.BSC,
  ...
  dryp: new ERC20Token(ChainId.BSC, '0x620Fdd450766c439230e72dF06b5EB9ec4d7fc6b', 9, 'DRYP', 'DRYP', ''),
  bpm: new ERC20Token(ChainId.BSC, '0x35359f21Abdf0f2B6aE01bFb96814738B515111e', 18, 'BPM', 'BPM', ''),

  ftm: new ERC20Token(ChainId.BSC, '0xad29abb318791d579433d831ed122afeaf29dcfe', 18, 'Fantom', 'FTM', ''),
