    ...
    <>
      {cakeBenefits && [VaultPosition.None, VaultPosition.Flexible].includes(cakeBenefits?.lockPosition) ? (
        <>
          ...
          <Message mt="8px" mb="16px" variant="warning">
            <MessageText maxWidth="200px">
              {t('Lock KNIGHT to enjoy the benefits of farm yield boosting!')}{' '}
              <NextLinkFromReactRouter
        ...
        <>
          ...
          <Message mt="8px" mb="16px" variant="warning">
            <MessageText maxWidth="200px">
              {t('Renew your staking position to continue enjoying the benefits of farm yield boosting!')}{' '}
              <NextLinkFromReactRouter
                style={{ textDecoration: 'underline', fontWeight: 'bold' }}
                to="/pools"
                onClick={onDismiss}
