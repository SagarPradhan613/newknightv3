        ...
        <AutoRow px={['0px', '0px', '16px']} py={['16px', '16px', '12px']} gap="8px">
          ...
          <DataRow
            label={
              <Tooltips
                content={t(
                  'The ratio factor between the amount of KNIGHT locked and the final veKNIGHT number. Extend your lock duration for a higher ratio factor.',
                )}
              >
          ...
          <DataRow
            label={
              <Tooltips
                content={t(
                  'Once locked, your KNIGHT will be staked in veKNIGHT contract until this date. Early withdrawal is not available.',
                )}
              >
                <TooltipText fontSize={14} fontWeight={400} color="textSubtle">
                  {t('Unlock on')}
