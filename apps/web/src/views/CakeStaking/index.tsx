          ...
          <BenefitCard
            headSlot={
              <QuestionHelper
                size="20px"
                text={t(
                  'Use your veKNIGHT to vote on your favourite farms, position managers, reward pools, and any KNIIGHT emission products, increase their allocations, and get more KNIGHT rewards.',
                )}
                placement="top"
                ml="4px"
              />
          ...
          <BenefitCard
            ...
            headSlot={
              <QuestionHelper
                size="20px"
                text={t(
                  'Boost your KNIGHTSwap farming APR by up to 2.5x. Aquire more veKNIGHT to receive a higher boost.',
                )}
                placement="top"
                ml="4px"
              />
          ...
          <BenefitCard
            ...
            headSlot={
              <QuestionHelper
                size="20px"
                text={t(
                  'Use veKNIGHT as your Snapshot voting power to vote on governance proposals. Including important protocol decisions, and adding new farming gauges.',
                )}
                placement="top"
                ml="4px"
              />
          ...
          <BenefitCard
            ...
            headSlot={
              <QuestionHelper
                size="20px"
                text={t(
                  'Use your veKNIGHT as your IFO Public Sales commit credits. Aquire more veKNIGHT to commit more in the next KNIGHTSwap IFOs.',
                )}
                placement="top"
                ml="4px"
              />
