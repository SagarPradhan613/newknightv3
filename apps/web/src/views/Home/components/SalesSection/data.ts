...
export const cakeSectionData = (t: TranslateFunction): SalesSectionProps => ({
  headingText: t('KNIGHT makes our world go round.'),
  bodyText: t(
    'KNIGHT token is at the heart of the KNIGHT ecosystem. Buy it, win it, farm it, spend it, stake it... heck, you can even vote with it!',
  ),
  reverse: false,
  primaryButton: {
