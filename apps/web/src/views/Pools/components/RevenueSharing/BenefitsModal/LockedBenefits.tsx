...
const LockedBenefits = () => {
  ...
  const bCakeTooltipComponent = () => (
    <>
      <Text>{t('bCAKE allows you to boost your yield in KNIGHT Farms by up to 2x.')}</Text>
  ...
  const vCakeTooltipComponent = () => (
    <>
      <Text>
        {t('vCAKE boosts your voting power to %totalScore% in the KNIGHT voting governance.', {
