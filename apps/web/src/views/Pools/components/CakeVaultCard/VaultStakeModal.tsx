...
const VaultStakeModal: React.FC<React.PropsWithChildren<VaultStakeModalProps>> = ({
  ...
  console.log('stakingtokenadreess', stakingToken.address)
    ...
    >
      <Flex alignItems="center" justifyContent="space-between" mb="8px">
        ...
        <Flex alignItems="center" minWidth="70px">
          ...
          <Text ml="4px" bold>
            {stakingToken.symbol === 'CAKE' ? 'KNIGHT' : stakingToken.symbol}
          </Text>
        </Flex>
      </Flex>
      <BalanceInput
      ...
      {!isRemovingStake && (
        <Button mt="8px" as="a" external href={getTokenLink} variant="secondary">
          ...
          {stakingToken.symbol === 'CAKE' ? t('Add KNIGHT') : t('Add %symbol%', { symbol: stakingToken.symbol })}
        </Button>
      )}
    </Modal>
  )
