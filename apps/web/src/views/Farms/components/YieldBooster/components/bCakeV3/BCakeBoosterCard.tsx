...
export const useBCakeTooltipContent = () => {
  ...
  const tooltipContent = (
    <>
      <Box mb="20px">
        {t(
          'Yield Boosters allow you to boost your farming yields by locking Knight in the fixed-term staking. The more Knight you lock, and the longer you lock them, the higher the boost you will receive.',
        )}
      </Box>
      {/* <Box>
    ...
    return (
      <Box>
        ...
        <Text color="textSubtle" fontSize={12} mb="16px">
          {t('An active veKNIGHT staking position is required for activating farm yield boosters.')}
        </Text>
  ...
  return (
    <Box>
      ...
      <Text color="textSubtle" fontSize={12} mb="10px">
        {t(
          'Boost unlimited number of positions on all V3 Farms. Boost will be applied when staking. Lock more KNIGHT or extend your lock to receive a higher boost.',
        )}
      </Text>
      <NextLink href="/cake-staking" passHref>
        <Button width="100%" style={{ backgroundColor: theme.colors.textSubtle }}>
