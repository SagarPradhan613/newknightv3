...
import { masterChefV2ABI, masterChefV2PANCAKEABI } from 'config/abi/masterchefV2'
...
export const getMasterChefPancakeContract = (signer?: WalletClient, chainId?: number) => {
  return getContract({
    abi: masterChefV2PANCAKEABI,
    address: getMasterChefV2PancakeAddress(chainId),
    chainId,
    signer,
  })
}
